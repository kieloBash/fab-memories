// app/(pages)/(protected)/(staff)/staff/vendor/page.tsx
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[13px] text-text-muted">Vendor portal</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {[
          ...
          { label: 'Confirmed events', value: '—' },
          { label: 'Open quotations', value: '—' },
          { label: 'Completed events', value: '—' },
        ].map((stat) => (
          <div
            key={stat.label}
      ...
      <p className="text-[13px] text-text-muted">
        Assigned events and quotations will render here.
      </p>
    </div>
  );
}
