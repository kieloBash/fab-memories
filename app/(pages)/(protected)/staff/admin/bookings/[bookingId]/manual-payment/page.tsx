// app/(pages)/(protected)/staff/admin/bookings/[bookingId]/manual-payment/page.tsx
"use client"
...
export default function AdminManualPaymentPage({ params }: Props) {
  ...
  const handleSubmit = () => {
    ...
    mutate(
      ...
      { onSuccess: () => router.push(`/staff/admin/bookings/${bookingId}`) },
    )
  }
