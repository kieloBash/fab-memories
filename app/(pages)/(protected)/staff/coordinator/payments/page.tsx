// app/(pages)/(protected)/staff/coordinator/payments/page.tsx
"use client"

/**
 * Coordinator-facing payments list — identical to the admin payments
 * list. The backend already permits COORDINATOR on verify/flag/manual
 * payment routes (requireRole(["ADMIN", "COORDINATOR"])); this page
 * existing is what actually gives coordinators reachable access to
 * that already-granted authority.
 */

import { useState } from "react"
import { useRouter } from "next/navigation"
import { motion } from "framer-motion"
import { usePayments, PAYMENT_STATUS_LABELS, PAYMENT_METHOD_LABELS } from "@/features/payments"
...
export default function CoordinatorPaymentsPage() {
  ...
  const [activeTab, setActiveTab] = useState<FilterStatus>("SUBMITTED")
            ...
            {isLoading ? (
              ...
              payments.map((payment) => (
                <TableRow
                  ...
                  onClick={() => router.push(`/staff/coordinator/payments/${payment.id}`)}
                >
